<div class="bg-sky-800 p-3 flex items-center justify-between">
    ...
    >
        ...
        >
            <svg class="lg:size-6 size-5" fill="currentColor" viewBox="0 0 24 24">
