                    ...
                    @else
                        <div class="flex justify-end mb-3">
                            <button
                                ...
                                class="bg-sky-100 w-fit hover:bg-sky-200 cursor-pointer rounded-xl shadow p-3 max-w-xs flex flex-col items-center space-x-3"
                            >
                                <div class="flex-1">
                                    <p
                                        wire:loading.remove
                                        wire:target="downloadFile"
                                        class="font-medium flex gap-2 items-center text-gray-800 mb-2">
                                        ...
                                        {{ Str::limit(pathinfo($message->latestMedia?->media_path, PATHINFO_FILENAME), 15) . '.' . pathinfo($message->latestMedia?->media_path, PATHINFO_EXTENSION)}}
                                    </p>
