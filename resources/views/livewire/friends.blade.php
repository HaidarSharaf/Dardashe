        ...
        <div class="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-1 max-h-[600px] overflow-y-auto">
            @forelse($friends as $friend)
                ...
                >
                    ...
                    <button class="flex font-semibold items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm text-white bg-blue-500 hover:bg-blue-600 rounded-lg transition-colors flex-shrink-0">
